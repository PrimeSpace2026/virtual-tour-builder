...
// Fallback images for tours loaded from backend
  ...
  useEffect(() => {
    getTours()
      .then((tours) => {
        ...
        const apiProjects = tours.map((t) => ({
          id: t.id + 1000, // offset to avoid ID conflicts with local
        ...
        setProjects([...localProjects, ...apiProjects]);
      })
      .catch((err) => {
