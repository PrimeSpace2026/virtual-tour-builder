        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, i) => (
              ...
              >
                <div className="text-3xl md:text-4xl font-display font-bold text-[#2c0a71] mb-2">
                  {stat.value}
                </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
            {useCases.map((useCase, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                variants={fadeUp}
                className="group p-8 rounded-2xl bg-card border border-border shadow-soft hover:shadow-elevated transition-all duration-300"
              >
                <div className="w-14 h-14 rounded-2xl bg-[#2c0a71]/10 flex items-center justify-center mb-6 group-hover:bg-[#2c0a71]/20 transition-colors">
                  <useCase.icon className="w-7 h-7 text-[#2c0a71]" />
                </div>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="rounded-2xl overflow-hidden shadow-elevated border border-border aspect-[4/3]">
                <iframe
              ...
              <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-[#2c0a71]/10 rounded-2xl -z-10" />
              <div className="absolute -top-4 -left-4 w-16 h-16 bg-[#2c0a71]/5 rounded-2xl -z-10" />
            </motion.div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-16">
            {workflows.map((workflow, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                variants={fadeUp}
                className="flex gap-6 p-8 rounded-2xl bg-card border border-border shadow-soft hover:shadow-elevated transition-all duration-300"
              >
                <div className="w-14 h-14 rounded-2xl bg-[#2c0a71]/10 flex items-center justify-center flex-shrink-0">
                  <workflow.icon className="w-7 h-7 text-[#2c0a71]" />
                </div>
                <div>
                  <h3 className="text-xl font-display font-semibold mb-3">
                    {workflow.title}
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
            >
              <blockquote className="text-2xl md:text-3xl font-display font-medium text-foreground leading-relaxed mb-8">
