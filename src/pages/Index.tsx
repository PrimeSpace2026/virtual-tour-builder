      ...
      <Dialog open={!!selectedProject} onOpenChange={(open) => !open && setSelectedProject(null)}>
        <DialogContent className="max-w-5xl w-[95vw] p-0 gap-0 overflow-hidden">
          ...
          <div className="aspect-video w-full relative">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-[6.25rem] bg-gradient-to-t from-black from-50% via-black/95 to-transparent flex items-end justify-center pb-3 pointer-events-none">
